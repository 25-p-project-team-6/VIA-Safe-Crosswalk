...
- 후속 실측에서 raw 640 float16/GPU는 20fps대, raw 512 float16/GPU는 30fps 근처로 관찰되었다. 기본 정책은 raw 640을 고해상도 후보로 유지하고, 런타임 Max Processed FPS 기본값을 20으로 제한해 발열/장기 안정성을 우선한다.
